-- CallTag Generic Webhook + Field Mapper (Phase 2)
-- Webhook endpoint secrets are stored as SHA-256 hashes only.
-- Raw webhook payloads are short-lived operational samples; mapping versions are durable.
