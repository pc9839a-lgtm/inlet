...
const IMG = {
  ...
  weddingTable: 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?auto=format&fit=crop&w=1200&q=86',
  weddingBouquet: 'https://images.unsplash.com/photo-1529634898760-1a3a1f064b62?auto=format&fit=crop&w=1200&q=86',
  ...
  estateLocation: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?auto=format&fit=crop&w=1200&q=84',
  estatePark: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=84',
  estateOffice: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=84',
  estateRetail: 'https://images.unsplash.com/photo-1518005020951-eccb494ad742?auto=format&fit=crop&w=1200&q=84',
};
...
const COPY = {
  ...
  'wedding-invitation': {
    ...
    form: ['참석 여부와 축하 메시지', '두 사람에게 전하고 싶은 마음과 참석 여부를 남겨주세요.', '마음 전하기'],
    questions: [['성함', 'short', true], ['참석 여부', 'select', true, ['참석합니다', '마음으로 축하합니다', '아직 미정입니다']], ['축하 메시지', 'long', true]],
    faq: [
  ...
  'quote-request': {
    ...
    location: ['입지 안내', '한강 생활권과 강남 접근성을 함께 누리는 입지입니다. 광역도로, 지하철, 업무지구 이동 동선을 중심으로 출퇴근과 주말 생활의 균형을 고려했습니다.'],
    development: ['주변호재', '수변공원 정비, 업무지구 확장, 생활 상권 개선이 맞물리는 권역입니다. 주거 만족도와 미래 선호도를 함께 기대할 수 있는 흐름에 주목했습니다.'],
...
function buildWedding(template, copy) {
  return [
    ...
    makeBlock('image', { mode: 'gallery', image: IMG.weddingCouple, gallery: [IMG.weddingCouple, IMG.weddingHero, IMG.weddingTable, IMG.weddingBouquet], imageFallback: placeholder('Wedding Photo', '#f7e7df'), imageDisplay: 'fill', imageHeightPx: 420, rounded: true, autoplay: true, interval: 5, galleryShowArrows: true, galleryShowDots: true, caption: '함께 걸어온 시간 위에 새로운 약속을 더합니다.' }),
    ...
    makeBlock('links', { title: copy.links[0], layout: 'card', items: [
      { id: uid(), emoji: '신랑', iconMode: 'thumb', thumb: IMG.weddingHero, label: copy.links[1], target: 'phone', url: 'tel:010-0000-0000' },
      { id: uid(), emoji: '신부', iconMode: 'thumb', thumb: IMG.weddingCouple, label: copy.links[2], target: 'phone', url: 'tel:010-0000-0000' },
...
function buildQuote(template, copy) {
  return [
    ...
    makeBlock('activity', { title: '실시간 접수 현황', mode: 'feed', dataSource: 'live', sampleKind: 'both', style: 'glass', animation: 'stack', align: 'left' }),
    ...
    makeBlock('image', { image: IMG.estateLocation, imageFallback: placeholder('Location', '#e0f2fe'), imageDisplay: 'fill', imageHeightPx: 300, rounded: true, caption: '' }),
    makeBlock('text', { title: copy.location[0], body: copy.location[1], layout: 'card', align: 'left', size: 'medium', anchorId: 'location' }),
    makeBlock('image', { mode: 'gallery', image: IMG.estateOffice, gallery: [IMG.estateOffice, IMG.estatePark, IMG.estateRetail, IMG.estateLounge], imageFallback: placeholder('Development', '#fef3c7'), imageDisplay: 'fill', imageHeightPx: 320, rounded: true, autoplay: true, interval: 3, galleryShowArrows: true, galleryShowDots: true, caption: '' }),
    makeBlock('text', { title: copy.development[0], body: copy.development[1], layout: 'notice', align: 'left', size: 'medium', anchorId: 'development' }),
