...
function AlignmentControl({ s, set, options = ALIGN, defaultValue = 'left' }) {
  return <SegmentedControl label="정렬" value={s.align || defaultValue} onChange={(value) => set({ align: value })} options={options} />;
}
