...
for (const [name, source, tokens] of [
  ...
  ['pages', pages, ['getD1PageBySlug', 'upsertD1Page', 'ensureD1ProjectShell', 'authorizeProject', 'PUBLIC_PAGE_CACHE_CONTROL', 'no-store', 'pages.revision DESC', 'PAGE_SLUG_CONFLICT', 'expectedUpdatedAt', 'PAGE_REVISION_CONFLICT']],
