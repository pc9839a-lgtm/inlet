...
for (const [name, source, tokens] of [
  ...
  ['google sheets oauth url', googleSheetsOauthUrl, ['googleSheetsAuthUrl', 'signedOAuthState', 'authorizeProject', "write: true", "tab: 'inbox'", 'sheetHeaders']],
  ['google sheets callback', googleSheetsCallback, ['verifyOAuthState', 'exchangeGoogleOAuthCode', 'createGoogleSpreadsheet', 'initializeGoogleSheetColumns', 'saveGoogleSheetsIntegration', 'payload.sheetHeaders', 'pagero:google-sheets-connected']],
  ...
  ['invites create', invitesCreate, ['createD1ManagerInvite', "tab: 'settings'", 'masterOnly: true', 'requireSignedSession: true', 'invite']],
  ...
  ['ownership project', ownershipProject, ['createD1OwnershipTransferRequest', 'listD1OwnershipTransfers', "tab: 'settings'", 'masterOnly', 'requireSignedSession: true']],
  ['ownership admin', ownershipAdmin, ['updateD1OwnershipTransferRequest', 'params.id', 'requirePlatformMaster']],
