...
requireAll(browserVisualQa, [
  ...
  'INLET_BROWSER_QA_AUTH_SESSION',
  'INLET_BROWSER_QA_AUTH_WORKSPACE_ID',
  'INLET_BROWSER_QA_CLICK_SELECTOR',
  'INLET_BROWSER_QA_POST_CLICK_SELECTOR',
...
requireAll(productionBrowserQa, [
  ...
  'INLET_PRODUCTION_QA_INCLUDE_AUTHENTICATED',
  'INLET_PRODUCTION_QA_INCLUDE_MOCKS',
  'INLET_BROWSER_QA_REQUIRE',
  'manager-limited',
  'owner-settings',
  'owner inbox duplicate policy',
  'owner settings page duplication modal',
  'INLET_PRODUCTION_QA_INCLUDE_NEXT_SETTINGS',
  'INLET_PRODUCTION_QA_SAVE_SET_INPUT',
  'INLET_PRODUCTION_QA_SAVE_POST_CLICK_SELECTOR',
  'owner server save round trip',
