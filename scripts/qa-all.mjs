...
const steps = [
  ...
  ['pagero:editor-inspector:compact-5:qa', ['scripts/pagero-editor-inspector-compact-5-quality-check.mjs']],
  ...
  ['authz:sensitive-project:qa', ['scripts/sensitive-project-authz-quality-check.mjs']],
  ...
  ['account:page-limit:live:contract:qa', ['scripts/account-page-limit-production-contract-check.mjs']],
  ...
  ['media:library:qa', ['scripts/media-library-quality-check.mjs']],
