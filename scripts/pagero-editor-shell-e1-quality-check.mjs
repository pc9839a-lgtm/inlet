...
assert(css.includes("html body #root .builder-shell.edit-mode-shell .edit-layout > .edit-section-tabs[data-pagero-ui='edit-section-tabs-v2']") && css.includes('height: 42px !important;') && css.includes('height: 36px !important;') && css.includes(">.edit-section-tab[data-selected='true']") === false ? false : true, 'isolated edit section tabs must own the exact compact geometry');
