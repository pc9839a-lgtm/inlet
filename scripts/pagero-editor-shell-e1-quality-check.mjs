...
assert(layout.includes('<SelectedBlockSettings') && layout.includes('<PageGlobalOptions') && layout.includes('<StylePanel'), 'inspector must own block, page and theme editing');
