...
assert(editLayout.includes('editor-inspector-pane') && editLayout.includes('페이지') && editLayout.includes('<PageGlobalOptions {...pageGlobalOptionsProps} />'), 'page options must live in the page inspector instead of a parallel top-level editor mode');
