...
assert(pageSaveAction.includes('saveInFlightRef.current') && pageSaveAction.includes("reason: 'save-in-progress'") && pageSaveAction.includes('setSaving(true)') && pageSaveAction.includes('setSaving(false)'), 'Page saves must serialize repeated save clicks and expose a stable saving state');
