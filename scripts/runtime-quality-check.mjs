...
assert(mediaBlocks.includes("s.galleryLayout === 'grid'") && mediaBlocks.includes('image-gallery-grid-${gallery.length}') && pageModel.includes("galleryLayout: ['slide','grid']"), 'image gallery grid mode must be sanitized and consumed by the public renderer');
