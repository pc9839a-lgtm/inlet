...
assert(landingRenderer.includes('navigator.share') && landingRenderer.includes('navigator.clipboard?.writeText') && landingRenderer.includes('bottom-share-button') && bottomBarBasicSection.includes('shareEnabled') && pageModel.includes('shareEnabled: true') && bottomShareCss.includes('.bottom-bar-actions.has-share'), 'Bottom bar sharing must open the mobile share sheet and copy the public URL as a desktop fallback');
