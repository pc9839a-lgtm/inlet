...
assert(browserSource.includes("clickButtonByText(client, '.editor-inspector-modes', '페이지')") && browserSource.includes("updatedAccent") && browserSource.includes(".style-apply-btn"), 'browser QA must preview and apply a page theme change from the unified inspector before publish');
